 ...
 */
public class PortableDeviceValues implements COMReferenceable {
    
    private COMReference pDeviceValues;
    
    PortableDeviceValues() throws COMException{
        pDeviceValues = COM.CoCreateInstance(WPD.CLSID_PortableDeviceValues, 0, 
                COM.CLSCTX_INPROC_SERVER, WPD.IID_IPortableDeviceValues);
    }
    
    PortableDeviceValues(COMReference pDeviceValues) {
    ...
    public native void setPortableDeviceValuesCollectionValue(PropertyKey key, PortableDevicePropVariantCollection value) throws COMException;
    public native PortableDevicePropVariantCollection getPortableDeviceValuesCollectionValue(PropertyKey key) throws COMException;
