 ...
 * @version 1.0
 */
class PortableDevicePropVariantCollection implements COMReferenceable {
    
    private COMReference pPropVariantCollection;
    
    PortableDevicePropVariantCollection() throws COMException {
    	pPropVariantCollection = COM.CoCreateInstance(WPD.CLSID_PortableDevicePropVariantCollection, 0, 
    			COM.CLSCTX_INPROC_SERVER, WPD.IID_IPortableDevicePropVariantCollection);
    }
    
    PortableDevicePropVariantCollection(COMReference pPropVariantCollection) {
