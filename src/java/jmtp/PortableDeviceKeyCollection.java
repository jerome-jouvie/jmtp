...
/**
 * The PortableDeviceKeyCollection object holds a collection of PropertyKey values.
 * @author Pieter De Rycke
 * @version 1.0
 */
class PortableDeviceKeyCollection implements COMReferenceable {
    
    private COMReference pKeyCollection;
    
    PortableDeviceKeyCollection() throws COMException {
        pKeyCollection = COM.CoCreateInstance(WPD.CLSID_PortableDeviceKeyCollection, 0, 
        		COM.CLSCTX_INPROC_SERVER, WPD.IID_IPortableDeviceKeyCollection);
    }
