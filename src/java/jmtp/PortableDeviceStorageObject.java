...
public class PortableDeviceStorageObject extends AbstractPortableDeviceContainer {

	PortableDeviceStorageObject(String objectID, PortableDeviceContent content,
